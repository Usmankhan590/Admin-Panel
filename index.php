                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <a href="registration.php">
                                            <i class="ti-layout-sidebar-left"></i> Registration
                                        </a>
                                    </li>
                                ...
                                <div class="main-menu-header">
                                    <img src="<?php
                                        if(!empty($_SESSION['img']))
                                            ...
                                            echo "assets/images/avatar-4.jpg"
                                    ?>" alt="picture"/>
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="login.php"><i class="ti-layout-sidebar-left"></i>Login</a>
                                            <a href="registration.php"><i class="ti-layout-sidebar-left"></i>Registration</a>
                                            <a href="product.php"><i class="ti-layout-sidebar-left"></i>Product</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
